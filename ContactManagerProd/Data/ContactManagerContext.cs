...
namespace ContactManager.Data
{
    public class ContactManagerContext : DbContext
    {
        ...
        public void Seed(ContactManagerContext context)
        {
            ...
            using (var reader = new StreamReader(@"contactmanagerprod.azurewebsites.net/Persons.csv"))
            ...
            using (var reader = new StreamReader(@"contactmanagerprod.azurewebsites.net/Businesses.csv"))
            using (var csv = new CsvReader(reader, config))
            {
            ...
            using (var reader = new StreamReader(@"contactmanagerprod.azurewebsites.net/Addresses.csv"))
            using (var csv = new CsvReader(reader, config))
            {   
